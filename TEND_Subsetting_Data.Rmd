...
### ifelse()
```{r}
#Here we are creating a new variable "Current_Med_String" to have strings of what was in numeric 1s (yes) and 0s (no) of whether someone was current on medications. This is an if else statemnet, It will look at all rows checking if "current_med" is equal to ("==") 1. if that is TRUE, "Current_Med_String" for that row will not equal "Meds", if it is not true (FALSE), it will return its ELSE statement "noMeds".
