...
# We will first create a df that allows us to visualize subsetting, and learn the 
# syntax used to call for certain variables like people aged over 30.
...
# Now, we will use na.rm(), which effectively
