...
```{r substring and subset, include=F, echo=F}
dep_scores <- read_csv("scores.csv", show_col_types = FALSE)
str(dep_scores)

# First
# Next, we will use the subsetting and substringing method together to remove both prefixes individually. We will actually use the 
